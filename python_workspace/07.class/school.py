...
# persons[0]--> person = Student("송민주", 31, "조리외식경영")
# persons[1]--> person = Student("김한비", 24, "러시아어")
# persons[2]--> person = Instructor("최현진", 25 , "클라우드")
# persons[3]--> person = Instructor("허승일", 28 , "클라우드")
# persons[4]--> person = Employee("김현주", 25, "클라우드 개발팀")
# persons[5]--> person = Employee("송현진", 26, "클라우드 개발팀")